  ...
  render() {
    ...
    return (
      <div className="index">
        ...
        <Tag actionIconSvgHref="/assets/svg-symbols.svg#cancel" accent="2" inverse actionable id="foo">
          Inverse Clearable
        </Tag>
        ...
        <Tag accent="2" actionable id="bar" actionIconSvgHref="/assets/svg-symbols.svg#cancel">Clearable</Tag>
